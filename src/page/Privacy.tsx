export default function Privacy() {
  return (
    <section className="prose lg:prose-xl text-justify mt-14 mx-auto">
      ...
      <p>
        Quotie Pockets is committed to protecting the privacy of its users. This
        Privacy Policy outlines the types of personal information that is
        received and collected by Quotie Pockets and how it is used.
      </p>
      <div>
        <h4>Information Collection and Use</h4>
        <ul>
          <li>
            Log Data: Like many website operators, we collect information that
          ...
          <li>
            Cookies: We use cookies to store information about visitors'
